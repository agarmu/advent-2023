...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `17.1µs` | `49.1µs` |
| [Day 2](./src/bin/02.rs) | `47.5µs` | `47.7µs` |
| [Day 3](./src/bin/03.rs) | `71.1µs` | `72.0µs` |
| [Day 4](./src/bin/04.rs) | `62.8µs` | `63.1µs` |
| [Day 5](./src/bin/05.rs) | `17.4µs` | `-` |
| [Day 6](./src/bin/06.rs) | `124.0ns` | `114.0ns` |
| [Day 7](./src/bin/07.rs) | `-` | `-` |
| [Day 8](./src/bin/08.rs) | `-` | `-` |
| [Day 9](./src/bin/09.rs) | `-` | `-` |
